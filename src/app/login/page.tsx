        ...
        <Card className="p-10 rounded-[3rem] border border-white/50 bg-white/60 backdrop-blur-3xl shadow-[0_30px_60px_-10px_rgba(0,0,0,0.1)]">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <Button className="w-full h-14 rounded-2xl font-black uppercase tracking-widest text-[11px] bg-primary-gradient text-white hover:opacity-90 shadow-xl shadow-primary/20 hover:scale-[1.02] transition-all mt-4">
