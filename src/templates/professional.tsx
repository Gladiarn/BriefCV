...
export const ProfessionalTemplate: React.FC<{ data: ResumeData }> = ({ data }) => {
  return (
    <div className="h-full text-slate-800 flex flex-col space-y-4 p-4 font-sans">
      ...
      <section>
        <h2 className="text-sm font-semibold text-blue-800 uppercase tracking-wider border-b pb-1 mb-2">Experience</h2>
        {data.experience.map((exp) => (
          <div key={exp.id} className="mb-3">
            <div className="font-semibold text-sm">{exp.title} at {exp.company}</div>
      ...
      <section>
        <h2 className="text-sm font-semibold text-blue-800 uppercase tracking-wider border-b pb-1 mb-2">Education</h2>
