...
export const BASICS_SECTION: FormSection = {
  ...
  icon: User,
  fields: [
    { id: "image", label: "Profile Picture", type: "image", placeholder: "URL", gridSpan: 2 },
    { id: "name", label: "Full Name", type: "text", placeholder: "Name", gridSpan: 1 },
    { id: "role", label: "Target Role", type: "text", placeholder: "Role", gridSpan: 1 },
    { id: "email", label: "Email Address", type: "email", placeholder: "Email", gridSpan: 1 },
    { id: "phone", label: "Phone", type: "tel", placeholder: "Phone", gridSpan: 1 },
    { id: "location", label: "Location", type: "text", placeholder: "Location", gridSpan: 1 },
    { id: "summary", label: "Professional Summary", type: "textarea", placeholder: "Summary...", gridSpan: 2 },
  ],
};
...
export const EXPERIENCE_SECTION: FormSection = {
  ...
  isRepeatable: true,
  fields: [
    { id: "company", label: "Company", type: "text", placeholder: "Company", gridSpan: 1 },
    { id: "role", label: "Role", type: "text", placeholder: "Role", gridSpan: 1 },
    { id: "startDate", label: "Start Date", type: "text", placeholder: "Start", gridSpan: 1 },
    { id: "endDate", label: "End Date", type: "text", placeholder: "End", gridSpan: 1 },
  ],
};
...
export const EDUCATION_SECTION: FormSection = {
  ...
  isRepeatable: true,
  fields: [
    { id: "institution", label: "Institution", type: "text", placeholder: "School", gridSpan: 2 },
    { id: "degree", label: "Degree", type: "text", placeholder: "Degree", gridSpan: 2 },
  ],
};
...
export const PROJECTS_SECTION: FormSection = {
  ...
  isRepeatable: true,
  fields: [
    { id: "title", label: "Title", type: "text", placeholder: "Title", gridSpan: 2 },
  ],
};
...
export const AWARDS_SECTION: FormSection = {
  ...
  icon: Trophy,
  fields: [
    { id: "awards", label: "Awards", type: "list", placeholder: "Add award", gridSpan: 2 },
  ],
};

export const ALL_SECTIONS = [BASICS_SECTION, EXPERIENCE_SECTION, EDUCATION_SECTION, PROJECTS_SECTION, AWARDS_SECTION];
...
export const templates: Template[] = [
  {
    ...
    sections: [BASICS_SECTION, EXPERIENCE_SECTION, EDUCATION_SECTION, AI_SECTION],
